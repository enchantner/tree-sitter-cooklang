...
enum ts_symbol_identifiers {
  ...
  aux_sym__name_multiword_repeat1 = 34,
  aux_sym__name_multiword_repeat2 = 35,
};
...
static inline bool sym__name_word_character_set_3(int32_t c) {
  return (c < 7294
    ? (c < 2404
      ? (c < 1370
        ? (c < '}'
...
static inline bool sym__name_word_character_set_4(int32_t c) {
  return (c < 7294
    ? (c < 2404
      ? (c < 903
        ? (c < '{'
...
static inline bool sym__alphabetic_character_set_1(int32_t c) {
  return (c < 6688
    ? (c < 2984
      ? (c < 2365
        ? (c < 1488
...
static inline bool sym__punctuation_character_set_2(int32_t c) {
  return (c < 7360
    ? (c < 2557
      ? (c < 1470
        ? (c < 167
  ...
  switch (state) {
    case 0:
      ...
      if (lookahead == '\t' ||
          ...
          lookahead == 8239 ||
          lookahead == 8287 ||
          lookahead == 12288) ADVANCE(48);
      if (sym__alphabetic_character_set_1(lookahead)) ADVANCE(47);
      END_STATE();
    case 1:
      if (lookahead == '\n') ADVANCE(27);
    ...
    case 6:
      ...
      if (lookahead == '\t' ||
          ...
          lookahead == 8239 ||
          lookahead == 8287 ||
          lookahead == 12288) ADVANCE(38);
      if (!sym__name_word_character_set_1(lookahead)) ADVANCE(38);
      END_STATE();
    case 7:
      if (lookahead == '-') ADVANCE(8);
      if (lookahead == '[') ADVANCE(9);
      ...
      if (lookahead == '\t' ||
          ...
          lookahead == 8287 ||
          lookahead == 12288) ADVANCE(38);
      if (!sym__name_word_character_set_2(lookahead)) ADVANCE(38);
      END_STATE();
    case 8:
    ...
    case 12:
      ...
      if (lookahead == '\t' ||
          ...
          lookahead == 8287 ||
          lookahead == 12288) ADVANCE(38);
      if (sym__punctuation_character_set_1(lookahead)) ADVANCE(55);
      if (lookahead != 0 &&
          lookahead != '#' &&
          lookahead != ':' &&
          lookahead != '@' &&
    ...
    case 37:
      ...
      if (lookahead == '/') ADVANCE(16);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(37);
      if (!sym__name_word_character_set_3(lookahead)) ADVANCE(38);
      END_STATE();
    case 38:
      ACCEPT_TOKEN(sym__name_word);
      if (!sym__name_word_character_set_4(lookahead)) ADVANCE(38);
      END_STATE();
    case 39:
    ...
    case 53:
      ...
      if (sym__punctuation_character_set_2(lookahead)) ADVANCE(54);
      if (lookahead != 0) ADVANCE(11);
      END_STATE();
    case 54:
      ACCEPT_TOKEN(sym__punctuation);
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [43] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(29),
  [46] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(24),
  [49] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(4),
  [52] = {.entry = {.count = 1, .reusable = false}}, SHIFT(9),
  [54] = {.entry = {.count = 1, .reusable = false}}, SHIFT(5),
  [56] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_step_repeat1, 2),
  [58] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_step_repeat1, 2), SHIFT_REPEAT(31),
  [61] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_step_repeat1, 2), SHIFT_REPEAT(29),
  [64] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_step_repeat1, 2), SHIFT_REPEAT(24),
  [67] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_step_repeat1, 2), SHIFT_REPEAT(5),
  [70] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_ingredient, 2),
  [72] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ingredient, 2),
  [74] = {.entry = {.count = 1, .reusable = true}}, SHIFT(13),
  [76] = {.entry = {.count = 1, .reusable = false}}, SHIFT(34),
  [78] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_cookware, 2),
  [80] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_cookware, 2),
  [82] = {.entry = {.count = 1, .reusable = true}}, SHIFT(12),
  [84] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_metadata, 4),
  [86] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_metadata, 4),
  [88] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_step, 2),
  [90] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_step, 2),
  ...
  [104] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__name_multiword, 2),
  [106] = {.entry = {.count = 1, .reusable = true}}, SHIFT(34),
  [108] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_timer, 5),
  [110] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_timer, 5),
  [112] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_cookware, 5),
  [114] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_cookware, 5),
  [116] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_ingredient, 5),
  [118] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ingredient, 5),
  [120] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_timer, 4),
  [122] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_timer, 4),
  [124] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_cookware, 4),
  [126] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_cookware, 4),
  [128] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__name_multiword_repeat2, 2),
  [130] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__name_multiword_repeat2, 2), SHIFT_REPEAT(34),
  [133] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_timer, 3),
  [135] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_timer, 3),
  [137] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_ingredient, 4),
  [139] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ingredient, 4),
  ...
  [149] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_quantity, 1),
  [151] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name, 1),
  [153] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_units, 1),
  [155] = {.entry = {.count = 1, .reusable = true}}, SHIFT(7),
  [157] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_amount, 1),
  [159] = {.entry = {.count = 1, .reusable = true}}, SHIFT(23),
  [161] = {.entry = {.count = 1, .reusable = true}}, SHIFT(6),
  [163] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__name_multiword_repeat1, 2),
  [165] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__name_multiword_repeat1, 2), SHIFT_REPEAT(33),
  ...
  [186] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_amount, 3),
